...
class exportTask extends sfBaseTask
{
  protected function configure()
  {
    ...
    // ));
		$defaulPoiXmlLocation = 'export/export_'.date('Ymd').'/pois/'.$city .'.xml';
    $this->addOptions(array(
      ...
      new sfCommandOption('poi-xml', null, sfCommandOption::PARAMETER_REQUIRED, 'Location of poi xml to check this export against', $defaulPoiXmlLocation),
  ...
  protected function getExporter( $options )
  {
    ...
    switch( strtolower($options['type']) )
    {
      ...
      case 'event':
        ...
        return new XMLExportEvent( $vendor, $options['destination'], $options['poi-xml'] );
        break;
      case 'movie':
