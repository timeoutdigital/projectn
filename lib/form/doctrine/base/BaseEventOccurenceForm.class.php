...
abstract class BaseEventOccurenceForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'vendor_event_occurence_id' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'vendor_event_occurence_id' => new sfValidatorString(array('max_length' => 10, 'required' => false)),
      ...
      'utc_offset'                => new sfValidatorString(array('max_length' => 6)),
