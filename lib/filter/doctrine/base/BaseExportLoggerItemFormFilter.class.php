...
/**
 * ExportLoggerItem filter form base class.
 *
 * @package    sf_sandbox
 * @subpackage filter
 ...
 */
abstract class BaseExportLoggerItemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('export_logger_item_filters[%s]');
