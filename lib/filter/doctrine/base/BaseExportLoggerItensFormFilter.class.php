...
/**
 * ExportLoggerItens filter form base class.
 *
 * @package    sf_sandbox
 * @subpackage filter
 ...
 */
abstract class BaseExportLoggerItensFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'vendor_item_id'   => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->widgetSchema->setNameFormat('export_logger_itens_filters[%s]');
