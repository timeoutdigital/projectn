...
/**
 * PoiCategoryMapping filter form base class.
 *
 * @package    sf_sandbox
 * @subpackage filter
 ...
 */
abstract class BasePoiCategoryMappingFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('poi_category_mapping_filters[%s]');
