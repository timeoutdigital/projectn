...
/**
 * PoiProperty filter form base class.
 *
 * @package    sf_sandbox
 * @subpackage filter
 ...
 */
abstract class BasePoiPropertyFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('poi_property_filters[%s]');
