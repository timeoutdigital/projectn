...
Doctrine_Manager::getInstance()->bindComponent('ExportLoggerItem', 'project_n');

/**
 * BaseExportLoggerItem
 * 
 ...
 * @method ExportLoggerItem setVendorItemId()     Sets the current record's "vendor_item_id" value
 * @method ExportLoggerItem setExportLogger()     Sets the current record's "ExportLogger" value
 * 
 * @package    sf_sandbox
 * @subpackage model
 ...
 */
abstract class BaseExportLoggerItem extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('export_logger_item');
