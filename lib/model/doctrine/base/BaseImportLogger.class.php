 ...
 * @method integer             getTotalErrors()         Returns the current record's "total_errors" value
 ...
 * @method ImportLogger        setTotalErrors()         Sets the current record's "total_errors" value
...
abstract class BaseImportLogger extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('total_errors', 'integer', null, array(
             'type' => 'integer',
             'notnull' => true,
             ));
