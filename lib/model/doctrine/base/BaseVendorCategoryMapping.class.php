 ...
 * @method VendorCategoryMapping setMapFromId()         Sets the current record's "map_from_id" value
 * @method VendorCategoryMapping setMapToId()           Sets the current record's "map_to_id" value
 * @method VendorCategoryMapping setVendorPoiCategory() Sets the current record's "VendorPoiCategory" value
 * @method VendorCategoryMapping setPoiCategory()       Sets the current record's "PoiCategory" value
 * 
 * @package    sf_sandbox
 * @subpackage model
 ...
 */
abstract class BaseVendorCategoryMapping extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('vendor_category_mapping');
