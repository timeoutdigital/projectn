 ...
 * @property Doctrine_Collection $RecordFieldOverrideMovie
 * 
 ...
 * @method Doctrine_Collection getRecordFieldOverrideMovie() Returns the current record's "RecordFieldOverrideMovie" collection
 ...
 * @method Movie               setRecordFieldOverrideMovie() Sets the current record's "RecordFieldOverrideMovie" collection
 * 
 * @package    sf_sandbox
 * @subpackage model
...
abstract class BaseMovie extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('RecordFieldOverrideMovie', array(
             'local' => 'id',
             'foreign' => 'record_id'));
