...
Doctrine_Manager::getInstance()->bindComponent('EventCategoryMapping', 'project_n');
 ...
 * @method EventCategoryMapping setMapFromId()           Sets the current record's "map_from_id" value
 * @method EventCategoryMapping setMapToId()             Sets the current record's "map_to_id" value
 * @method EventCategoryMapping setVendorEventCategory() Sets the current record's "VendorEventCategory" value
 * @method EventCategoryMapping setEventCategory()       Sets the current record's "EventCategory" value
 * 
 * @package    sf_sandbox
 * @subpackage model
