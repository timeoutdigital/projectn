 ...
 * 
 * @property integer $vender_poi_id
 ...
 * 
 * @method integer             getVenderPoiId()                Returns the current record's "vender_poi_id" value
 ...
 * @method Poi                 setVenderPoiId()                Sets the current record's "vender_poi_id" value
...
abstract class BasePoi extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('vender_poi_id', 'integer', null, array(
             'type' => 'integer',
             'notnull' => false,
             ));
        ...
        $this->hasColumn('longitude', 'decimal', 4, array(
             'type' => 'decimal',
             'notnull' => true,
             'length' => '4',
             ));
        $this->hasColumn('latitude', 'decimal', 4, array(
             'type' => 'decimal',
             'notnull' => true,
             'length' => '4',
             ));
    ...
    public function setUp()
    {
        ...
        $this->hasMany('PoiUserContent as Poi', array(
             'local' => 'id',
             'foreign' => 'poi_id'));
