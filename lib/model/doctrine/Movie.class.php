...
class Movie extends BaseMovie
{
  ...
  */
    ...
    public function setUnsolvable( $is_unsolvable, $comment = null )
  {
      ...
      {
          throw new MovieException('Invalid parameter value');
      }
      ...
      $existing_meta = null;
      foreach( $this['MovieMeta'] as $meta )
      {
      ...
      if($is_unsolvable )
      {
          ...
          $this['MovieMeta'][] = $existing_meta;

      }else{

          $this->unlink( 'MovieMeta', $existing_meta['id'] );
