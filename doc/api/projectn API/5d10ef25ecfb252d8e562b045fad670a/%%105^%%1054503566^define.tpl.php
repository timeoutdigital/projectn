<?php /* Smarty version 2.6.0, created on 2010-01-29 11:35:05
         compiled from define.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'define.tpl', 4, false),)), $this); ?>
...
</span>&nbsp;&nbsp;<span class="smalllinenumber">[line <?php if ($this->_tpl_vars['defines'][$this->_sections['def']['index']]['slink']):  echo $this->_tpl_vars['defines'][$this->_sections['def']['index']]['slink'];  else:  echo $this->_tpl_vars['defines'][$this->_sections['def']['index']]['line_number'];  endif; ?>]</span>
		</span>
	</div>
<br />
...
$this->_smarty_include(array('smarty_include_tpl_file' => "docblock.tpl", 'smarty_include_vars' => array('sdesc' => $this->_tpl_vars['defines'][$this->_sections['def']['index']]['sdesc'],'desc' => $this->_tpl_vars['defines'][$this->_sections['def']['index']]['desc'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "tags.tpl", 'smarty_include_vars' => array('api_tags' => $this->_tpl_vars['defines'][$this->_sections['def']['index']]['api_tags'],'info_tags' => $this->_tpl_vars['defines'][$this->_sections['def']['index']]['info_tags'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	<br />
