<?php /* Smarty version 2.6.0, created on 2010-02-08 10:55:38
...
?>
	  <?php if ($this->_tpl_vars['info_tags'][$this->_sections['tag']['index']]['keyword'] != 'author'): ?>
		<tr>
		  <td>
		    <strong><?php echo ((is_array($_tmp=$this->_tpl_vars['info_tags'][$this->_sections['tag']['index']]['keyword'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
:</strong>&nbsp;&nbsp;
		  </td>
		  <td><?php echo $this->_tpl_vars['info_tags'][$this->_sections['tag']['index']]['data']; ?>
</td>
		</tr>
	  <?php endif; ?>
    <?php endfor; endif; ?>
