...
/**
 * Test class for nyImportBc.
 * Generated by PHPUnit on 2010-02-12 at 15:11:03.
 */
class nyImportBcTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
         try {
          ...
          //Add one of the existing ones from the xml
           ...
           $this->existingPoiObj['longitude'] = '0.000';
           $this->existingPoiObj['latitude'] = '0.000';
        ...
        $this->object = new nyImportBc($this->xmlObj, $this->vendorObj );
    ...
    /**
     * @todo Implement testImportBars().
     */
    public function testNoImportforExistingBar()
    {
        $this->assertTrue($this->object->testIfPoiExists($this->getXMLString()));
