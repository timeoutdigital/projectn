...
class barcelonaMoviesMapperTest extends PHPUnit_Framework_TestCase
{
  ...
  protected function setUp()
  {
    ...
    $this->params = array( 'type' => 'movie', 'curl' => array( 'classname' => 'CurlMock', 'src' => TO_TEST_DATA_PATH . '/barcelona/movies_trimmed.xml' ) );
  }
  ...
  public function testMapMovies()
  {
    ...
    $importer->addDataMapper( new barcelonaMoviesMapper( $this->vendor, $this->params ) );
    $importer->run();
