 ...
 *
 */
class pnWidgetFormDatePicker extends sfWidgetForm
{
    /**
    * Constructor.
    *
    ...
    */
    ...
    public function render($name, $value = null, $attributes = array(), $errors = array())
    {
       ...
       $output = $this->renderTag( 'input',
        ...
        {
            $onSelect = "function( dateText, inst ){  $('#".$attributes['update']."').val( dateText  ) ; }";
        }

        $script = <<<JS
        $(function()
        {
            $('#{$id}').datepicker( {dateFormat: 'yy-mm-dd' , onSelect: $onSelect } );
        });
JS;
